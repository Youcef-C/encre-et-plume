...
function makeWorkspace(): ProjectWorkspaceResponse {
  return {
    ...
    pages: [
      { id: 'pg1', chapterId: 'c2', title: 'Planche 5', stage: 'scenario', position: 0, fileTags: ['scenario'], linkedFileIds: [], linkedFiles: [], dueDate: null, labels: [], assignees: [], checklistDone: 0, checklistTotal: 0, commentCount: 0, openCorrectionCount: 0, openCorrectionTypes: [], createdById: null, handoff: null, scenarioUnsaved: false },
      { id: 'pg2', chapterId: 'c1', title: 'Planche 1', stage: 'scenario', position: 0, fileTags: [], linkedFileIds: [], linkedFiles: [], dueDate: null, labels: [], assignees: [], checklistDone: 0, checklistTotal: 0, commentCount: 0, openCorrectionCount: 0, openCorrectionTypes: [], createdById: null, handoff: null, scenarioUnsaved: false },
      { id: 'pg3', chapterId: 'c1', title: 'Brouillon', stage: 'scenario', position: 0, fileTags: [], linkedFileIds: [], linkedFiles: [], dueDate: null, labels: [], assignees: [], checklistDone: 0, checklistTotal: 0, commentCount: 0, openCorrectionCount: 0, openCorrectionTypes: [], createdById: null, handoff: null, scenarioUnsaved: false },
    ],
