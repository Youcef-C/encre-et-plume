...
- Shared genres will need an update by adding a +18 value to the object, differenciating it from mature content. +18 content is not a genre but a rating, it should be treated as such.
...
- New genre object format: `{ "id": string, "fr": string, "en": string, "mature": boolean, "plus18": boolean }`
