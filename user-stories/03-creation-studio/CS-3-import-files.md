...
- Business rules: validate extension/type and size on upload; type chip derived from file kind; **versioning is linear** (v1…vN, no branching/merge); re-import of a linked file appends a version, it does not spawn a new asset.
