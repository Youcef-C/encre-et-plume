...
> Screen(s): the "Infos" / project settings surface ([[CS-10]]/[[CS-2]]) · Priority: Should · Fidelity: **Inferred** (no drawn frame — a destructive lifecycle action; grade against the criteria)
...
- A **"Supprimer le projet"** action in the project settings / "Infos" surface, styled destructive (accent red), **leader-only** (hidden for co-leaders/members/non-members).
...
- [[CS-10]] — leader role gates delete/restore; opened from "Infos".
