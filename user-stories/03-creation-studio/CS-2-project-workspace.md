...
- **INFOS**: editable "TITRE" / "SYNOPSIS" / "HASHTAGS" with auto-save; "Demandes de collaboration" toggle; "Retours des lecteur·rices" reviews list ([[PUB-3]]) with admin moderation affordances ([[AD-5]]).
