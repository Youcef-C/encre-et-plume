...
- Update the Candidature status on the applicant side. If a Candidature has been accepted, it must show replace the "Candidature envoyé" by the actual status (either "Accepté" or "Refusé").
